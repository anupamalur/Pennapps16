package com.example.user.pennapps16;
...
public class ExcerciseActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        overlayView.show3DToast("Press the button to exit!");
